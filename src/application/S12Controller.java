...
public class S12Controller implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		ObservableList<PieChart.Data> pieChartData12 =
                ...
                new PieChart.Data("Food", Food.moneyFood12),
                new PieChart.Data("Clothes", Clothes.moneyClothes12),
                new PieChart.Data("Drinks", Drinks.moneyDrinks12),
                new PieChart.Data("DailySupplies", DailySupplies.moneyDaily12),
                new PieChart.Data("HairAndCosmetic", HairAndCosmetic.moneyHair12),
                new PieChart.Data("Gathering", Gathering.moneyGathering12),
                new PieChart.Data("Studying", Studying.moneyStudying12),
                new PieChart.Data("Hobbies", Hobbies.moneyHobbies12),
                new PieChart.Data("Traffic", Traffic.moneyTraffic12),
                new PieChart.Data("Health", Health.moneyHealth12),
                new PieChart.Data("Else", Else.moneyElse12));
