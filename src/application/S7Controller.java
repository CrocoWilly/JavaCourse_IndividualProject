...
public class S7Controller implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		ObservableList<PieChart.Data> pieChartData7 =
                ...
                new PieChart.Data("Food", Food.moneyFood7),
                new PieChart.Data("Clothes", Clothes.moneyClothes7),
                new PieChart.Data("Drinks", Drinks.moneyDrinks7),
                new PieChart.Data("DailySupplies", DailySupplies.moneyDaily7),
                new PieChart.Data("HairAndCosmetic", HairAndCosmetic.moneyHair7),
                new PieChart.Data("Gathering", Gathering.moneyGathering7),
                new PieChart.Data("Studying", Studying.moneyStudying7),
                new PieChart.Data("Hobbies", Hobbies.moneyHobbies7),
                new PieChart.Data("Traffic", Traffic.moneyTraffic7),
                new PieChart.Data("Health", Health.moneyHealth7),
                new PieChart.Data("Else", Else.moneyElse7));
