...
public class S11Controller implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		ObservableList<PieChart.Data> pieChartData11 =
                ...
                new PieChart.Data("Food", Food.moneyFood11),
                new PieChart.Data("Clothes", Clothes.moneyClothes11),
                new PieChart.Data("Drinks", Drinks.moneyDrinks11),
                new PieChart.Data("DailySupplies", DailySupplies.moneyDaily11),
                new PieChart.Data("HairAndCosmetic", HairAndCosmetic.moneyHair11),
                new PieChart.Data("Gathering", Gathering.moneyGathering11),
                new PieChart.Data("Studying", Studying.moneyStudying11),
                new PieChart.Data("Hobbies", Hobbies.moneyHobbies11),
                new PieChart.Data("Traffic", Traffic.moneyTraffic11),
                new PieChart.Data("Health", Health.moneyHealth11),
                new PieChart.Data("Else", Else.moneyElse11));
