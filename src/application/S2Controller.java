...
public class S2Controller implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		ObservableList<PieChart.Data> pieChartData2 =
                ...
                new PieChart.Data("Food", Food.moneyFood2),
                new PieChart.Data("Clothes", Clothes.moneyClothes2),
                new PieChart.Data("Drinks", Drinks.moneyDrinks2),
                new PieChart.Data("DailySupplies", DailySupplies.moneyDaily2),
                new PieChart.Data("HairAndCosmetic", HairAndCosmetic.moneyHair2),
                new PieChart.Data("Gathering", Gathering.moneyGathering2),
                new PieChart.Data("Studying", Studying.moneyStudying2),
                new PieChart.Data("Hobbies", Hobbies.moneyHobbies2),
                new PieChart.Data("Traffic", Traffic.moneyTraffic2),
                new PieChart.Data("Health", Health.moneyHealth2),
                new PieChart.Data("Else", Else.moneyElse2));
